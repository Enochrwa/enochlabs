    ...
    <footer className="border-t border-rule/60">
      <div className="mx-auto flex max-w-content flex-col gap-6 px-6 py-10 sm:flex-row sm:items-center sm:justify-between">
        ...
        <nav className="flex flex-wrap gap-x-6 gap-y-2 font-body text-sm text-ink-100/70">
          <Link href="/services" className="transition hover:text-seal">
            Services
          </Link>
          <Link href="/work" className="transition hover:text-seal">
            Work
          </Link>
          <Link href="/pricing" className="transition hover:text-seal">
            Pricing
          </Link>
          <Link href="/contact" className="transition hover:text-seal">
            Contact
          </Link>
          <a
